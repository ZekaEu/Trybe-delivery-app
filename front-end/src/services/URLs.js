...
export const GET_USERS = 'http://localhost:3001/login/users';
export const DELETE_USERS = 'http://localhost:3001/login/user';
...
export const POST_SALE = 'http://localhost:3001/login/sales';
